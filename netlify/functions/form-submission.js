...
async function handler(event) {
  ...
  // If this is a GET request, redirect to success page immediately
  if (event.httpMethod === "GET") {
    console.log("GET request detected, redirecting to success page");
    return {
      statusCode: 303,
      headers: {
        "Location": "/success.html"
      },
      body: "Redirecting to success page..."
    };
  }
  ...
  if (event.httpMethod === "POST") {
    try {
      ...
      console.log("EMAIL_PORT set:", !!process.env.EMAIL_PORT);
      console.log("EMAIL_SECURE set:", process.env.EMAIL_SECURE);
      console.log("EMAIL_USER set:", !!process.env.EMAIL_USER);
      console.log("EMAIL_PASS set:", !!process.env.EMAIL_PASS);
      console.log("SITE_URL set:", process.env.SITE_URL);
  ...
  // If we somehow get here with a different method, redirect anyway
  return {
    statusCode: 303,
    headers: {
      "Location": "/success.html"
